...
function popupLatLngHTML(lngLat, zLevel) {
    return '<p><strong>Get directions:<strong></p><p><a href="%globals_asset_url:43989%?lngA='+lngLat.lng+'&latA='+lngLat.lat+'&zA='+zLevel+'" class="set-start">Start Here</a> or <a href="%globals_asset_url:43989%?lngB='+lngLat.lng+'&latB='+lngLat.lat+'&zB='+zLevel+'" class="set-end">End here</a></p>';
}