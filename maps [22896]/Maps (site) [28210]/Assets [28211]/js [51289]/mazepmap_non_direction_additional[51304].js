...
function popupPoiHTML(poi) {
	...
	+toTitleCase(poi.properties.floorName):'')+'</p><p><strong>Get directions:<strong></p><p><a href="%globals_asset_url:43989%?pointA='+poi.properties.poiId+'" class="set-start">Start Here</a> or <a href="%globals_asset_url:43989%?pointB='+poi.properties.poiId+'" class="set-end">End here</a></p>';
}

function popupLatLngHTML(lngLat, zLevel) {
    return '<h4><a href="%globals_asset_url:67217%?lat='+lngLat.lat+'&lng='+lngLat.lng+'">Selected Location</a></h4><p><strong>Get directions:<strong></p><p><a href="%globals_asset_url:43989%?lngA='+lngLat.lng+'&latA='+lngLat.lat+'&zA='+zLevel+'" class="set-start">Start Here</a> or <a href="%globals_asset_url:43989%?lngB='+lngLat.lng+'&latB='+lngLat.lat+'&zB='+zLevel+'" class="set-end">End here</a></p>';
}